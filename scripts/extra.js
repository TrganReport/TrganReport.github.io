...
const trganMethods = ["Write","SaveAsFile","AddEntry","AddColumn","GetScreenshot","FromBase64","FromBytes","CreateTest", "CreateContainer", "Generate","CreateStep","Pass","Fail","Skip","Log"];
const trganProperties = ["AsBase64EncodedString","AsByteArray","ValueOf","Status", "Name", "Message","Given"];
